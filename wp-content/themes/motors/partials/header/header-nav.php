...
$showCart = stm_me_get_wpcfto_mod( 'header_cart_show', false );
        ...
        <div class="container">
            ...
            <div class="header-help-bar">
                <ul>
                    ...
                    <?php if ( $showCart && !empty( $woocommerce_shop_page_id ) ): ?>
                    ...
                    <?php if(stm_me_get_wpcfto_mod('hma_search_button', false)): ?>
                        <li class="nav-search">
                            <a href="" data-toggle="modal" data-target="#searchModal"><?php echo stm_me_get_wpcfto_icon('hma_search_button_icon', 'stm-icon-search'); ?></a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
