...
$mapStartZoom = ( !empty( $map_zoom ) ) ? $map_zoom : 5;
...
<script>
    ...
    jQuery(document).ready(function ($) {
        ...
        function init() {
            ...
            var mapOptions = {
                zoom: <?php echo esc_js( $mapStartZoom ); ?>,
                center: center,
            ...
            $.ajax({
                ...
                success: function (msg) {
                        ...
                        google.maps.event.addListener(marker, 'mouseover', (function (marker, i) {
                            return function () {
                                ...
                                if (mapLocationCar[locations[i]["lat"]].length == 1) {
                                    ...
                                    $('body').find(".stm_if_group_scroll .stm_if_scroll").mCustomScrollbar({
                                        theme: "dark"
                                    });

                                    if (stm_check_mobile()) {
                                        $('body').find(".stm_if_group_scroll .stm_if_scroll").mCustomScrollbar('destroy');
                                    }
                                }
                            }
                    ...
                    markerCluster = new MarkerClusterer(map, markers, {
                        ...
                        averageCenter: true,
                        styles: [{
                            url: '<?php echo stm_do_lmth( $cluster_url_path ); ?>',
                            textColor: 'white',
                            height: 60,
                            width: 60,
                            textSize: 20
