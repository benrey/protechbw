...
function stm_load_all_icons()
{
	...
	wp_enqueue_style( 'stm-theme-aircrafts-icons', get_theme_file_uri( '/assets/css/stm-aircrafts-font-style.css' ), null, STM_THEME_VERSION, 'all' );
}
...
function stm_load_theme_ss()
{
	...
	//header styles
	if ( stm_me_get_wpcfto_mod( 'site_style', 'site_style_default' ) == 'site_style_default' && !stm_is_auto_parts() && !stm_is_rental_two() ) {
	...
	wp_enqueue_style( 'font-awesome-4.7.0', get_theme_file_uri( '/assets/css/font-awesome.min.css' ), null, STM_THEME_VERSION, 'all' );
	...
	if ( stm_me_get_wpcfto_mod( 'site_style', 'site_style_default' ) != 'site_style_default' and is_dir( $upload_dir['basedir'] . '/stm_uploads' ) ) {
...
if ( !function_exists( 'stm_motors_enqueue_scripts_styles' ) ) {
	...
	{
		if ( stm_me_get_wpcfto_mod( 'site_style', 'site_style_default' ) != 'site_style_default' ) return;
...
if ( !function_exists( 'stm_motors_enqueue_header_scripts_styles' ) ) {
	...
	{
		if ( stm_me_get_wpcfto_mod( 'site_style', 'site_style_default' ) == 'site_style_default' && file_exists( get_theme_file_path( '/assets/css/dist/headers/' . $fileName . '.css' ) ) ) {
...
if ( !function_exists( 'stm_default_google_fonts_enqueue' ) ) {
	function stm_default_google_fonts_enqueue()
	{
		...
		$typography_body_font_family = stm_me_get_wpcfto_mod( 'typography_body_font_family' );
		if ( !empty( $typography_body_font_family['font-data']['family'] ) ) $font_families[strtolower( str_replace( ' ', '_', $typography_body_font_family['font-data']['family'] ) )] = $typography_body_font_family['font-data']['family'] . ':' . implode( ',', $typography_body_font_family['font-data']['variants'] );
		
		$typography_heading_font_family = stm_me_get_wpcfto_mod( 'typography_heading_font_family' );
		if ( !empty( $typography_heading_font_family['font-data']['family'] ) ) $font_families[strtolower( str_replace( ' ', '_', $typography_heading_font_family['font-data']['family'] ) )] = $typography_heading_font_family['font-data']['family'] . ':' . implode( ',', $typography_heading_font_family['font-data']['variants'] );
		
		$typography_menu_font_family = stm_me_get_wpcfto_mod( 'typography_menu_font_family' );
		if ( !empty( $typography_menu_font_family['font-data']['family'] ) ) $font_families[strtolower( str_replace( ' ', '_', $typography_menu_font_family['font-data']['family'] ) )] = $typography_menu_font_family['font-data']['family'] . ':' . implode( ',', $typography_menu_font_family['font-data']['variants'] );
		
		$typography_main_menu_font_family = stm_me_get_wpcfto_mod( 'typography_main_menu_font_settings' );
		if ( !empty( $typography_main_menu_font_family['font-data']['family'] ) ) $font_families[strtolower( str_replace( ' ', '_', $typography_main_menu_font_family['font-data']['family'] ) )] = $typography_main_menu_font_family['font-data']['family'] . ':' . implode( ',', $typography_main_menu_font_family['font-data']['variants'] );
		
		$logo_font_family = stm_me_get_wpcfto_mod( 'logo_font_family' );
		if ( !empty( $logo_font_family['font-data']['family'] ) ) $font_families[strtolower( str_replace( ' ', '_', $logo_font_family['font-data']['family'] ) )] = $logo_font_family['font-data']['family'] . ':' . implode( ',', $logo_font_family['font-data']['variants'] );
