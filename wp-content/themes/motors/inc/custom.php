...
if ( !function_exists( 'stm_body_class' ) ) {
    function stm_body_class( $classes )
    {
        ...
        if ( defined('STM_ENABLE_FRONTEND_CUSTOMIZER') ) {
        ...
        if ( $layout == 'car_dealer_two' ) {
            ...
            $inventoryClass = ( is_singular( array( stm_listings_post_type() ) ) ||
                ...
                ( !empty($wp_query->post->ID) && $wp_query->post->ID == stm_me_get_wpcfto_mod( 'listing_archive', '' ) ) ) ? ' inventory-' . stm_me_get_wpcfto_mod( 'inventory_layout', 'dark' ) : '';
        ...
        if ( stm_is_rental() and is_page( stm_me_get_wpcfto_mod( 'rental_datepick', false ) ) ) {
        ...
        if( stm_is_aircrafts() ){
            ...
            if(!empty($wp_query->post) && $wp_query->post->ID == stm_me_get_wpcfto_mod( 'listing_archive', '' )) $classes[] = 'stm-inventory-page';
        }
...
if ( !function_exists( 'stm_print_styles_color' ) ) {
    function stm_print_styles_color()
    {
		...
		$STM_CCH = new STM_Custom_Colors_Helper();
        ...
        if ( $site_color_style != 'site_style_default' ) {
            ...
            if ( $layout == 'motorcycle' ) {
				...
				$custom_style_css .= $STM_CCH->stm_cch_get_css_modules();
                ...
                if ( $layout !== 'boats' ) {
                    ...
                    if ( stm_is_auto_parts() ) {
                        ...
                        $base_color = ( $site_color_style == 'site_style_custom' ) ? stm_me_get_wpcfto_mod( 'site_style_base_color', $predefined_colors[$l]['site_style_blue']['primary'] ) : $predefined_colors[$l]['site_style_blue']['primary'];
                        $secondary_color = ( $site_color_style == 'site_style_custom' ) ? stm_me_get_wpcfto_mod( 'site_style_secondary_color', $predefined_colors[$l]['site_style_blue']['secondary'] ) : $predefined_colors[$l]['site_style_blue']['secondary'];
                        $third_color = ( $site_color_style == 'site_style_custom' ) ? stm_me_get_wpcfto_mod( 'site_style_base_color_listing', $predefined_colors[$l]['site_style_blue']['third'] ) : $predefined_colors[$l]['site_style_blue']['third'];
                        $four_color = ( $site_color_style == 'site_style_custom' ) ? stm_me_get_wpcfto_mod( 'site_style_secondary_color_listing', $predefined_colors[$l]['site_style_blue']['four'] ) : $predefined_colors[$l]['site_style_blue']['four'];
...
if ( !function_exists( 'stm_boats_styles' ) ) {
    function stm_boats_styles()
    {
        ...
        if ( stm_is_boats() ) {
            $header_bg_color = stm_me_get_wpcfto_mod( 'header_bg_color', '#002568' );
            $top_bar_bg_color = stm_me_get_wpcfto_mod( 'top_bar_bg_color', '#002568' );
        ...
        if ( stm_is_motorcycle() or stm_is_rental()) {
            ...
            $site_bg = stm_me_get_wpcfto_mod( 'site_bg_color', $defColor );
        ...
        if ( stm_is_dealer_two() ) {
            ...
            if ( !empty( $stm_single_car_page ) && ( is_singular( array( stm_listings_post_type() ) ) || is_post_type_archive( stm_listings_post_type() ) || ( get_the_ID() == stm_me_get_wpcfto_mod( 'listing_archive', '' ) ) ) ) {
                $front_css = '
				#main {
					background-image: url(" ' . $stm_single_car_page . ' ");
                    background-repeat: no-repeat;					
        ...
        if(defined('STM_MOTORS_CLASSIFIED_FIVE')) {
			$header_bg_color = stm_me_get_wpcfto_mod( 'header_bg_color', '' );
			$top_bar_bg_color = stm_me_get_wpcfto_mod( 'top_bar_bg_color', '' );
...
if ( !function_exists( 'stm_listings_filter_classified_title' ) ) {
    function stm_listings_filter_classified_title( $params )
    {
        ...
        $title_generated_postfix = stm_me_get_wpcfto_mod( 'listing_directory_title_generated_affix', esc_html__( ' for sale', 'motors' ) );
