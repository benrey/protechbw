<?php
$logo_main = stm_me_get_wpcfto_img_src( 'logo', get_template_directory_uri() . '/assets/images/tmp/air_craft_logo.svg' );
...
$bodyFixed = (is_front_page() || get_the_ID() == stm_me_get_wpcfto_mod( 'listing_archive', '' )) ? 'stm-body-fixed' : '';
