<?php
$logo_main = stm_me_get_wpcfto_img_src('logo', get_template_directory_uri() . '/assets/images/tmp/magazine-logo/logo.svg');
			...
			<?php else: ?>
				<a class="bloglogo" href="<?php echo esc_url(home_url('/')); ?>">
					<img
						...
						style="width: <?php echo stm_me_get_wpcfto_mod( 'logo_width', '112' ); ?>px;"
