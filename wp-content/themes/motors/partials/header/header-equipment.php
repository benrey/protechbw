<?php
$logo_main = stm_me_get_wpcfto_img_src('logo', get_template_directory_uri() . '/assets/images/tmp/logo_dealer_two.svg');
			...
			<div class="listing-right-actions">
                <div class="head-phone-wrap">
                    <div class="ph-title heading-font">
						<?php echo stm_me_get_wpcfto_icon('header_main_phone_icon', 'fa fa-phone'); ?>
