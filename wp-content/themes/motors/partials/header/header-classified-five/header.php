...
$logo_main = stm_me_get_wpcfto_img_src( 'logo', get_template_directory_uri() . '/assets/images/tmp/logo_c_five.svg' );
...
$header_listing_btn_link = (is_listing(array('listing_five'))) ? stm_c_f_get_page_url( 'add_listing' ) : stm_me_get_wpcfto_mod('header_listing_btn_link', '/add-car');
        ...
        <div class="container">
            <div class="row header-row" >
                <div class="col-md-2 col-sm-12 col-xs-12">
                    ...
                    <?php
						$compare_page = (is_listing(array('listing_five', 'listing_six'))) ? \uListing\Classes\StmListingSettings::getPages("compare_page") : stm_me_get_wpcfto_mod( 'compare_page', 156 );
                            ...
                            <div class="stm-c-f-add-btn-wrap">
                                <a class="add-listing-btn stm-button heading-font"
                                   href="<?php echo esc_html($header_listing_btn_link); ?>">
									<?php echo stm_me_get_wpcfto_icon('header_listing_btn_icon', 'stm-all-icon-listing_car_plus'); ?>
                                    <?php echo esc_html($header_listing_btn_text); ?>
                                </a>
                            </div>
                        <?php endif; ?>
