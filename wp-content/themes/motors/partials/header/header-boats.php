<?php
$logo_main = stm_me_get_wpcfto_img_src('logo', get_template_directory_uri() . '/assets/images/tmp/logo-boats.png');
...
<div class="header-listing header-listing-boats <?php echo esc_attr($fixed_header_class.' '.$transparent_header_class); ?>">
	...
	<div class="container header-inner-content">
		...
		<div class="listing-service-right clearfix" style="<?php echo stm_me_wpcfto_parse_spacing(stm_me_get_wpcfto_mod( 'menu_icon_top_margin', array('top' => '0'))); ?>">
			...
			<ul class="listing-menu boats-menu-<?php echo (wp_is_mobile()) ? 'ipad' : 'desktop'; ?> clearfix" style="<?php echo stm_me_wpcfto_parse_spacing(stm_me_get_wpcfto_mod( 'menu_top_margin', array('top' => '0'))); ?>">
				<?php
