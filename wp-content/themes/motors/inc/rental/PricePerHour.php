	...
	public static function pricePerHourView()
	{
        ...
        <div class="admin-rent-info-wrap">
            <ul class="stm-rent-nav-tabs">
                ...
                <li>
                    <a class="stm-nav-link" data-id="discount-by-days"><?php echo (stm_me_get_wpcfto_mod('enable_fixed_price_for_days', false)) ? esc_html__( 'Fixed Price By Quantity Days', 'motors' ) : esc_html__( 'Discount By Days', 'motors' ); ?></a>
                </li>
                <li>
