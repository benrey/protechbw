...
add_filter( 'motors_get_all_wpcfto_config', function ( $global_conf ) {
	$conf = array(
		'classic_listing_title_bg' =>
			array(
				'label' => esc_html__( 'Listing Archive &quot;Title Box&quot; Background', 'stm_motors_extends' ),
				'type' => 'image',
				'dependency' => [
		...
		'listing_directory_title_generated_affix' =>
			array(
				'label' => esc_html__( 'Generated Title Affix', 'stm_motors_extends' ),
				'type' => 'text',
				'value' => ' for sale',
				'dependency' => [
					'key' => 'header_current_layout',
				...
				'fields' =>
					array(
						...
						'to' =>
							array(
								'type' => 'text',
								'label' => esc_html__( 'To', 'stm_vehicles_listing' )
							),
					),
				'submenu' => esc_html__( 'Price', 'stm_motors_extends' ),
			),
