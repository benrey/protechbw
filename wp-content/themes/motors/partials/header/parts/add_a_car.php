<?php
$header_listing_btn_link = ( stm_is_listing_five() ) ? stm_c_f_get_page_url( 'add_listing' ) : stm_me_get_wpcfto_mod( 'header_listing_btn_link', '/add-a-car' );
$header_listing_btn_link = ( stm_is_listing_six() ) ? stm_c_six_get_page_url( 'add_listing' ) : stm_me_get_wpcfto_mod( 'header_listing_btn_link', '/add-a-car' );
