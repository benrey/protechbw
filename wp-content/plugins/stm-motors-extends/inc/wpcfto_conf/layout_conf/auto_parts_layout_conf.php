		...
		'fields' =>
			array(
				'wcmap_best_selling_ico' =>
					array(
						'label' => esc_html__( 'Icon For Best Seller Product', 'stm_motors_extends' ),
						'type' => 'image',
					),
				'wcmap_top_rate_ico' =>
					array(
						'label' => esc_html__( 'Icon For Top Rated Product', 'stm_motors_extends' ),
						'type' => 'image',
					),
				'wcmap_sale_ico' =>
					array(
				...
				'wcmap_single_product_template' => array(
					...
					'options' => array(
						...
						'template_1' => esc_html__( 'Template 1', 'stm_motors_extends' ),
					),
